...
select count(*) from employees where to_date ='9999-01-01';
...
-- 문제6.
-- 현재 부서 매니저는 몇 명이나 있나요?(역임 매너저는 제외), 현재인 매니저
select * from dept_manager where to_date = '9999-01-01';

-- 문제7.
-- 전체 부서를 출력하려고 합니다. 순서는 부서이름이 긴 순서대로 출력해 보세요.(order by에 조건 length)
